...
export default function Example() {
  return (
    <footer className="bg-bgred" aria-labelledby="footer-heading">
        ...
        <div className="border-t border-white pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
          <div>
            ...
            <p className="mt-2 text-xl text-white">
              Stay up to date on special announcements, launches, and more!
            </p>
          </div>
          <form className="mt-4 sm:flex sm:max-w-md lg:mt-0">
            ...
            <input
              ...
              placeholder="hi@boxies.nft"
            />
            <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                type="submit"
                className="w-full bg-white text-bgred border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-xl font-bold text-white"
              >
                SUBSCRIBE
              </button>
            </div>
